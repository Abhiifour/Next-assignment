    ...
    return (
        <div className="flex gap-5 justify-center p-6 sm:flex-col sm:w-full">
            ...
            <div className="bg-gradientPink p-10 w-[60%] rounded-xl sm:w-full">
                <div className="font-medium text-[43px] leading-[53px] text-blackText sm:text-[32px] sm:leading-[40px]">Sinscrire & économiser <span className="text-textblue  ">10% </span></div>
                <div className=" mt-6 text-bannerText text-[14px] leading-[22px] font-medium font-geist">Office ipsum you must be muted. Synergize helicopter prioritize anyway job due harvest most opportunity didnt. 
